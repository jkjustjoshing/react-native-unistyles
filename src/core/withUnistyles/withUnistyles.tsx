import React, { useEffect, useState, type ComponentType, forwardRef, useRef, useMemo, type ComponentProps } from 'react'
...
// @ts-expect-error
export type GenericComponentProps<P> = ComponentProps<P>
...
export const withUnistyles = <TComponent, TMappings extends GenericComponentProps<TComponent>>(Component: TComponent, mappings?: Mappings<TMappings>) => {
    ...
    return forwardRef<TProps, PropsWithUnistyles>((props, ref) => {
