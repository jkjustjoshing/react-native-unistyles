...
export class UnistylesState {
    ...
    init = (config: UnistylesConfig) => {
        ...
        this.services.UnistylesListener.initListeners()
    }
    ...
    private initSettings = (settings: UnistylesSettings) => {
        ...
        if (settings.adaptiveThemes) {
            ...
            this.themeName = schemeToTheme(this.services.UnistylesRuntime.colorScheme) as AppThemeName
        ...
        breakpointsEntries
            ...
            .forEach(([breakpoint, value]) => {
                ...
                mediaQuery.addEventListener('change', event => {
                    ...
                    this.services.UnistylesListener.emitChange(UnistyleDependency.Breakpoints)
                })
            })
    }
}
